/*
 * Copyright (c) 1018, hiwepy (https://github.com/easy-4-java).
 *
...
import org.apache.shiro.oauth.exception.OAuthAuthenticationException;
...
public final class OauthAuthenticatingFilter extends AbstractAuthenticatingFilter {
	 ...
	 * {@link #createToken(jakarta.servlet.ServletRequest, jakarta.servlet.ServletResponse)
